![HASS Core Installer](hasslogo.png "HASS Core Installer")
# HASS Core Installer
...
2. python3-dev, python3-pip, ensurepip

   On Debian/Ubuntu: ```apt install python3.12-venv python3-dev python3-pip```
   On Fedora/RedHat: ```dnf install python3-virtualenv python3-devel python3-pip```
